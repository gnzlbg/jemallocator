...
# Travis-CI sets TERM=xterm, but this states that the terminal
# support things like CLI tools using a progress bar, which
# can result in huge logs. We lose colors by doing this, oh well...
export TERM=dumb
